...
public class iitdActivity extends AppCompatActivity {
    private static String accessToken;
    static final int REQUEST_GALLERY_IMAGE = 20;
    static final int REQUEST_CODE_PICK_ACCOUNT = 21;
    static final int REQUEST_ACCOUNT_AUTHORIZATION = 22;
    static final int REQUEST_PERMISSIONS = 23;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ActivityCompat.requestPermissions(iitdActivity.this,
        ...
        switch (requestCode) {
            case REQUEST_PERMISSIONS:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(iitdActivity.this, "Permission Denied!", Toast.LENGTH_SHORT).show();
                }
        }
    }
